...
The v5.0.2 release target and runtime contract contain **218 configurable tools**, with **212 advertised by default** because the six `codex_*` delegation tools are opt-in. The Windows installer for the current version is `rvn-Setup-5.0.2.exe`.
