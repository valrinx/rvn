...
const MCP_FAILURE_RESULT_CODES = {
  ...
  AGENT_SESSION_MISMATCH: true,
  AGENT_SESSION_CONFLICT: true,
  SESSION_ALREADY_BOUND: true,
  TASK_SCOPE_VIOLATION: true,
  MESSAGE_NOT_FOUND: true,
  MESSAGE_SCOPE_VIOLATION: true,
  LOCK_CONFLICT: true,
  LOCK_NOT_FOUND: true,
  LOCK_SCOPE_VIOLATION: true,
  ARTIFACT_NOT_FOUND: true,
  WORKTREE_CONFLICT: true,
  WORKTREE_NOT_FOUND: true,
  WORKTREE_SCOPE_VIOLATION: true,
  ROOM_NOT_FOUND: true,
  ROOM_ALREADY_EXISTS: true,
  ROOM_PARTICIPANT_NOT_FOUND: true,
  ROOM_PARTICIPANT_REQUIRED: true,
  ROOM_TARGET_NOT_FOUND: true,
  ROOM_MESSAGE_NOT_FOUND: true,
  ROOM_MESSAGE_SCOPE_VIOLATION: true,
